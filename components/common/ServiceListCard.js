...
const ServiceListCard = ({title , content}) => {
  return (
    <div className="flex flex-col items-center justify-start p-[1.375rem] hover:border-[0.24px] border-black hover:shadow-2xl rounded-xl  w-[calc(50%-9px)] sm:w-[calc(50%-21px)] lg:w-[calc(25%-31.5px)] ">
      <img
